...
public class Transferir extends JDialog {
	...
	private void iniciarComponentes() {
		...
		labelTitulo = new JLabel("Transferir");
		...
		txtConta.addItem("Conta Poupança");
		txtConta.addItem("Conta Corrente");
		...
		txtContaDestino.addItem("Conta Poupança");
		txtContaDestino.addItem("Conta Corrente");
	...
	private void tranferir() {
		try {
			...
			if (txtConta.getSelectedItem().toString().equals("Conta Poupança")) {
				conta = Banco.getUsuarioLogado().getContaPoupanca().getNumero();
			} else if (txtConta.getSelectedItem().toString().equals("Conta Corrente")) {
			...
			if (txtContaDestino.getSelectedItem().toString().equals("Selecione a conta destino")) {
				...
				JOptionPane.showMessageDialog(this, info, "Banco Java", JOptionPane.ERROR_MESSAGE);
				return;
			} else if (txtContaDestino.getSelectedItem().toString().equals("Conta Poupança")) {
				contaDestino = Banco.getUsuarioLogado().getContaPoupanca().getNumero();
			} else if (txtContaDestino .getSelectedItem().toString().equals("Conta Corrente")) {
